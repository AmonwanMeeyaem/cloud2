...
async function postapi(imgname, data) {
    ...
    const response = await fetch("https://0af6ldmi00.execute-api.us-east-1.amazonaws.com/upload", {
        method: 'PUT',
    ...
    const response2 = await fetch("https://8ff8p3hhcj.execute-api.us-east-1.amazonaws.com/api/imagestorecloud/"+imgname, {
        method: 'PUT',
        body: data
    });  
